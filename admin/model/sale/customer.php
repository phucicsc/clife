...
class ModelSaleCustomer extends Model {
	...
	public function editCustomer($customer_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "customer SET customer_code = '" . $this->db->escape($data['customer_code']) . "', date_birth = '".$date_birth."', date_cmnd = '".$date_cmnd."', address_cmnd = '" . $this->db->escape($data['address_cmnd']) . "', ma_thue = '" . $this->db->escape($data['ma_thue']) . "', note = '" . $this->db->escape($data['note']) . "', firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', username = '" . $this->db->escape($data['username']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', custom_field = '" . $this->db->escape(isset($data['custom_field']) ? serialize($data['custom_field']) : '') . "', cmnd = '" . $this->db->escape($data['cmnd']) . "', account_bank = '" . $this->db->escape($data['account_bank']) . "', address_bank = '" . $this->db->escape($data['address_bank']) . "', address_cus = '" . $this->db->escape($data['address_cus']) . "',img_profile = '" . $this->db->escape($data['img_profile']) . "',date_added = '".$date_create."' WHERE customer_id = '" . (int)$customer_id . "'");
		...
		if ($data['status']) {
			$this->db->query("UPDATE " . DB_PREFIX . "customer SET status = '" . (int)$data['status'] . "',date_off = '' WHERE customer_id = '" . (int)$customer_id . "'");
		}
