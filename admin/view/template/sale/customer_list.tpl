...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
     ...
     <?php }?>
      <?php /*?>   <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-customer').submit() : false;"><i class="fa fa-trash-o"></i></button> <?php */ ?>
    ...
    <?php /*?>
      ...
      <div class="panel-body">
          ...
          <div class="row">
           ...
           <div class="row">
           		<div class="col-sm-3">
           			<button id="button-filter-user-new" data-loading-text="Danh sách HV mới" class="btn btn-primary"><i class="fa fa-search"></i> Danh sách HV mới</button>
           		</div>
           		<div class="col-sm-3">
           			<button id="button-filter-user-notHP" data-loading-text="Danh sách HV chưa đóng phí" class="btn btn-primary"><i class="fa fa-search"></i> Danh sách HV chưa đóng phí</button>
           		</div>
           		<div class="col-sm-3">
           			<button id="button-filter-user-off" data-loading-text="Danh sách HV off" class="btn btn-primary"><i class="fa fa-search"></i> Danh sách HV off</button> 
           		</div>
           		<div class="col-sm-3">
           			<button id="button-filter-user-ctp" data-loading-text="Công tác phí HV" class="btn btn-primary"><i class="fa fa-search"></i> Công tác phí HV</button> 
           		</div>
           </div>
         </div>
      </div>
      ...
      <div class="panel-body">
        <div class="well">
          <div class="row">
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-name">Tên hội viên</label>
                <input type="text" name="filter_name" value="<?php echo $filter_name; ?>" placeholder="Tên hội viên" id="input-name" class="form-control" />
              </div>
            </div>
            <?php /*?>
            <div class="col-sm-3">
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td>STT</td>
                  <td>Mã hội viên</td>
                  <td style="width: 250px;" class="text-left" ><?php if ($sort == 'name') { ?>
                    <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                    <?php } ?></td>
                  <td>Ngày sinh</td>
                  <td style="width: 110px;">Điện thoại</td>
                  <td style="width: 250px;">Người giới thiệu</td>
                  <?php /* ?>
              ...
              <tbody>
                ...
                <tr class="<?php  if($customer['hvOff'] == 1) { echo $customer['hvNew'] == true? 'hvNew ':'';} else echo 'hvOff';?>">
                  ...
                  <td class="text-left" style="color:#2c69c6"><?php echo $customer['name']; ?></td>
                  <td class="text-left"><?php echo $customer['date_birth']; ?></td>
