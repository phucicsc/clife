                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <p class="help-none" id="c-wallet" data-value="<?php echo str_replace(',','',number_format($c_wallet) )?>">C-Wallet: <?php echo number_format($c_wallet) ?> VND</p>
                                                        <p class="help-none" id="r-wallet" data-value="<?php echo str_replace(',','',number_format($r_wallet) ) ?>">R-wallet: <?php echo number_format($r_wallet) ?> VND</p>
                                                    </div>
                                                </div>
                                                <div class="form-group">
